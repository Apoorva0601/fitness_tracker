...
const Button = ({ 
  ...
  const variants = {
    ...
    outline: 'border border-gray-300 dark:border-dark-600 bg-white dark:bg-dark-800 hover:bg-gray-50 dark:hover:bg-dark-700 text-gray-700 dark:text-gray-300 focus:ring-primary-500',
